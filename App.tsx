                            ...
                            <div key={entry.id} className="bg-[var(--theme-card-bg)] p-4 rounded-xl flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-4">
                                     <div className="text-right">
                                        ...
                                        <p className={`text-xs font-semibold px-2 py-0.5 rounded-full ${entry.fuelType === FuelType.ETHANOL ? 'bg-green-800/50 text-green-300' : 'bg-red-800/50 text-red-300'}`}>{entry.fuelType}</p>
                                    </div>
